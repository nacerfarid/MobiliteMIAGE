...
public class ListViewAdapterH extends BaseAdapter {
    ...
    public ListViewAdapterH(Context context, ArrayList<String> shortNames, ArrayList<String> arretsLabel, ArrayList<String> bgColors, ArrayList<String> txtColors)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_arret_history, parent, false);
        }
        // Lookup view for data population
        TextView tvName = convertView.findViewById(R.id.arretHistorique);
