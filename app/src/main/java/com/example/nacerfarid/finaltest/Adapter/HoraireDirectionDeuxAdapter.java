...
public class HoraireDirectionDeuxAdapter extends BaseAdapter
{
    private final Context context;
    private final List<String> arrets;
    private final List<String> delay;

    public HoraireDirectionDeuxAdapter(Context context, List<String> arrets, List<String> delay)
    {
    ...
    public View getView(int position, View view, ViewGroup viewGroup)
    {
        ...
        if(view == null)
        {
            view = LayoutInflater.from(context).inflate(R.layout.item_direction_deux_layout_textview, viewGroup, false);
        }
